    ...
    private void StartUpload() {
        ...
        rf.putFile(path).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                DocumentReference df = firestore.collection("User").document(auth.getCurrentUser().getUid()).collection("photo").document();
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(photo.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}